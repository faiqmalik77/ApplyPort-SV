...
export default function DashboardPage() {
  return (
    <PageShell
      title="Dashboard"
      subtitle="Overview of your activity — applications, updates, and shortcuts."
    >
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm text-[var(--muted)]">
              ...
              <li className="flex justify-between gap-4">
                ...
                <span className="shrink-0 text-[var(--foreground)]">See offers</span>
              </li>
            </ul>
          </div>
        </FadeIn>
        <FadeIn delay={0.1}>
          <div className="glass sticky top-28 rounded-2xl p-6">
            ...
            <p className="mt-6 text-xs text-[var(--muted)]">
              Your overview updates as you submit applications and receive decisions.
            </p>
          </div>
        </FadeIn>
      </div>
